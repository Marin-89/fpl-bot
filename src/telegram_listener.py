...
def _handle_lineup_request():
    # Re-read state fresh here (not the outer copy) so this reflects the
    # very latest "processing" flag, in case a scheduled run just started.
    ...
    from . import main as main_mod  # local import avoids a circular import at module load time
